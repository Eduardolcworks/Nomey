...
transferencias Personal en el cliente, hecha el 2026-09-20; siguen C2 y C3).
La **Fase 10** cerró el
...
(C1 hecha el 2026-09-20; faltan C2 y C3).** La identidad pública existe de
...
- **Solicitud de pago** ([F12/ADR-004](adr/F12/ADR-004-payment-request-links.md)):
  ...
  incorpora el token lo construye F12.C. Precisiones en
  [`docs/adr/F12/README.md`](adr/F12/README.md).
...
| **Transferencias entre usuarios, solicitud de pago** | **Decididas en F12.A0** (F12/ADR-002…004, 2026-09-17); **username hecho** (F12.A, 2026-09-19); **F12.B cerrado** (2026-09-20): B1 (propuestas e `internal_transfer` de dos voluntades), B2 (solicitud de pago mediante enlace) y B3 (propuesta de grupo y `settlement_by_transfer` algebraica) hechos; **F12.C en curso**: C1 (transferencias Personal en el cliente) hecha; faltan C2 (solicitud de pago y enlace), C3 (grupo) y F12.D (cierre). **Push de transferencias diferido** hasta Apple Developer/APNs/build instalada                                                                                                                                                                                                                                                                                                                       |
