...
Actualizado el **2026-09-16**, al **cerrar la Fase 10** (identidad contextual y
ciclo de vida del vínculo: identidad permanente, vínculo activo/histórico,
modo Invitado real, cierre de alcance de cesiones y fusiones, y el punto de
inicio del Modo Personal tras el Invitado; F10/ADR-001 … 005, F05/ADR-003).
La **Fase 9** cerró el 2026-09-14. Incluye el cierre de **F11.A** (decisiones de
...
|                         |                                                                                                                                                                                                                                                                                                                                                                                      |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Fases en curso**      | **Fase 8** (distribución interna: F8.A0 … F8.A5 cerrados, **F8.B** y **F8.C** pendientes) y **Fase 11** abierta (**F11.A** cerrada, contrato sin implementación; F11.B en preparación). **Fase 11** abierta: **F11.A** cerrada (contrato, sin implementación)                                                                                                                        |
...
| **ADR aceptados**       | 48 de 49 (F00–F11; F00/ADR-001 sigue Propuesto), organizados por fase en docs/adr/FNN/                                                                                                                                                                                                                                                                                               |
...
del vínculo ajeno **prohibida**), la transferencia ordenada desde la app (F12,
