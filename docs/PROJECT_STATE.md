...
|                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Fases en curso**      | **Fase 8** (distribución interna: F8.A0 … F8.A5 cerrados, **F8.B** y **F8.C** pendientes) y **Fase 11** abierta (**F11.A** cerrada; **F11.B**: B1–B3 integrados, B4 en curso, ninguna operación convierte todavía). **Fase 12** abierta el 2026-09-17: **F12.A0** cerrado (cuatro ADR aceptados), **F12.A … F12.D** pendientes, **ninguna implementación iniciada**                                                                                                                                        |
