...
está en curso. Ninguna operación convierte todavía.
...
**F11.A está CERRADA, y la conversión todavía no existe en el código:** de
F11.B están integrados el catálogo FX, la ingesta y la fijación diaria del tipo,
y el resolver está en curso, pero ningún writer convierte. [F11/ADR-001](adr/F11/ADR-001-fx-rate-resolution.md) fija lo que F11.B y F11.C
