...
|                         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Fases en curso**      | **Fase 8** (distribución interna: F8.A0 … F8.A5 cerrados, **F8.B** y **F8.C** pendientes) y **Fase 11** abierta (**F11.A** cerrada; **F11.B**: B1–B3 integrados, B4 en curso, ninguna operación convierte todavía). **Fase 12** abierta el 2026-09-17: **F12.A0** y **F12.A** cerrados (identidad pública: backend, alta con hook y cliente con gate, Perfil y offline-first, 2026-09-19); **F12.B en curso**: B1 (propuestas y `internal_transfer` de dos voluntades, `20260926120000`) implementado, B2 y B3 pendientes; después F12.C y F12.D                                                              |
...
- **Solicitud de pago** ([F12/ADR-004](adr/F12/ADR-004-payment-request-links.md)):
  ...
  solicitante y `paid` es para siempre. Sin grupo, sin deuda.
...
| **Transferencias entre usuarios, solicitud de pago** | **Decididas en F12.A0** (F12/ADR-002…004, 2026-09-17); **username hecho** (F12.A, 2026-09-19); **F12.B en curso**: B1 (propuestas e `internal_transfer` de dos voluntades) hecho, B2 (solicitud de pago) y B3 (transferencia de grupo) pendientes; después F12.C (cliente de transferencias) y F12.D (cierre)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
