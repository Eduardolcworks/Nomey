...
| **F12.B**  | Backend de transferencias, en tres PR: **B1** propuestas Personal e `internal_transfer` de dos voluntades (`20260926120000`, 2026-09-19: propuesta, aceptación, cancelar y rechazar, partes por versión, irreversibilidad, `my_transfer_proposals` y `my_transfers`, check, carreras, frontera HTTP §18); **B2** solicitud de pago por enlace; **B3** transferencia de grupo (`settlement_by_transfer` con el nuevo contrato)                                                                                                                  | **En curso** (B1 hecho)  |
