...
| **F12.B**  | Backend de transferencias, en tres PR: **B1** propuestas Personal e `internal_transfer` de dos voluntades (`20260926120000`, 2026-09-19: propuesta, aceptación, cancelar y rechazar, partes por versión, irreversibilidad, `my_transfer_proposals` y `my_transfers`, check, carreras, frontera HTTP §18); **B2** solicitud de pago por enlace (`20260927120000`, 2026-09-20: solicitud al portador con token entregado una vez, previsualización por estados con freno, pago por token como segundo origen XOR de `record_internal_transfer`, cancelar, tope exacto de 20 pendientes, `my_payment_requests`, check, carreras, frontera HTTP §19); **B3** transferencia de grupo (`settlement_by_transfer` con el nuevo contrato) | **En curso** (B1 y B2 hechos) |
