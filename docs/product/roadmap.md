...
| **F12.C**  | Cliente de transferencias, en tres PR: **C1** transferencias Personal (2026-09-20, validado en iPhone: `+ → Transferencia`, búsqueda exacta por `@username`, propuesta pendiente sin efecto hasta aceptar, aceptar/rechazar/cancelar, `/transfers` sólo con pendientes, campana y banner, `my_transfers` en Movimientos; **push diferido**: eventos previstos `proposal_received`, `proposal_accepted`, `proposal_declined`, sin importe ni concepto en el payload, y en iPhone exige Apple Developer, APNs y build instalada — F8.B); **C2** Solicitar dinero y su enlace; **C3** transferencia en Grupo; retirada de los placeholders heredados. Mejor tras F11.C por la hoja de alta. (El username en el alta, el gate y Perfil los cerró F12.A3)                                                                                                                                                                                                                                                                                                                                                     | Pendiente                |
