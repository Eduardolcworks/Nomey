...
| [F10](F10/README.md) | Identidad contextual y ciclo de vida del vínculo | [ADR-001](F10/ADR-001-link-instance-lifecycle.md) · `ADR-002` previsto                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
- **Cesión consentida atómica y fusión fantasma ↔ fantasma** (F10, será
  `F10/ADR-002`). El ciclo de vida del vínculo propio —principio de no
  adjudicación de la identidad ajena, dejar cualquier instancia propia bajo
  una regla temporal de obligaciones, identidad y procedencia de la instancia,
  disputas sin consentimiento— **ya está decidido por
  [F10/ADR-001](F10/ADR-001-link-instance-lifecycle.md) (Aceptado)**. La identidad y el vínculo los
