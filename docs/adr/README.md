...
| [F12/ADR-008](F12/ADR-008-identity-after-email-confirmation.md)               | La identidad pública se completa después de confirmar el correo: el alta es correo y contraseña, y el gate pide nombre y username (supersede el paso 4 de F12/ADR-001 §5) | Aceptado  | 2026-09-25 |
