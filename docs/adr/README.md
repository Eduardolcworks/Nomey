...
| [F10](F10/README.md) | Identidad contextual y ciclo de vida del vínculo | [ADR-001](F10/ADR-001-link-instance-lifecycle.md) · [ADR-002](F10/ADR-002-permanent-identity.md) · [ADR-003](F10/ADR-003-active-and-historical-link.md) · `ADR-004` previsto                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
- **Cesión consentida atómica y fusión fantasma ↔ fantasma** (F10, será
  `F10/ADR-004`; el `F10/ADR-003` que F10/ADR-002 anticipaba lo tomó el ciclo
  de vida del vínculo). El ciclo de vida del vínculo propio —principio de no
  adjudicación de la identidad ajena, identidad y procedencia de la instancia,
