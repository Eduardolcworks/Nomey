...
| [F10](F10/README.md) | Participantes sin cuenta                 | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- **Participantes sin cuenta: revocación por otro y fusión de cuentas** (F10) —
  la identidad y el vínculo los cerró
  [F03/ADR-009](F03/ADR-009-participant-identity.md); la invitación, la
  rectificación propia y la asociación del propio fantasma los cerró F09
  ([F09/ADR-004](F09/ADR-004-group-invitations.md),
