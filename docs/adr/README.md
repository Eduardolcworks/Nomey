...
| [F05](F05/README.md) | Identidad y sesión                               | [ADR-001](F05/ADR-001-secure-session-storage.md) · [ADR-002](F05/ADR-002-ephemeral-recovery-session.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [F10](F10/README.md) | Identidad contextual y ciclo de vida del vínculo | [ADR-001](F10/ADR-001-link-instance-lifecycle.md) (Propuesto) · `ADR-002` previsto                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [F11](F11/README.md) | Multimoneda operativa                            | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [F12](F12/README.md) | Capacidades compartidas avanzadas                | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
- **Ciclo de vida del vínculo propio** (F10, **redactado como [F10/ADR-001](F10/ADR-001-link-instance-lifecycle.md), Propuesto**): principio de
  no adjudicación de la identidad ajena, dejar cualquier instancia propia de
  vínculo bajo una regla temporal de obligaciones, identidad y procedencia de la
  instancia, disputas sin consentimiento. **Cesión consentida atómica y fusión
  fantasma ↔ fantasma** (F10, será `F10/ADR-002`). La identidad y el vínculo los
  cerró [F03/ADR-009](F03/ADR-009-participant-identity.md); la invitación, la
  rectificación propia, la asociación del propio fantasma y la reincorporación
  los cerró F09 ([F09/ADR-004](F09/ADR-004-group-invitations.md),
  [F09/ADR-006](F09/ADR-006-unclaim-participant.md),
...
- **Tipos de cambio y conversión** (F11): fuente con histórico por fecha
  efectiva, política de selección que
  [F02/ADR-001](F02/ADR-001-money-representation.md) dejó abierta, cambio de
  moneda base.
...
- **Transferencia ordenada desde la app y acceso residual** (F12) — distintos
  del pago declarado de
  [F09/ADR-007](F09/ADR-007-group-payments-and-exit-without-debt.md).
