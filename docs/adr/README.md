...
| [F10](F10/README.md) | Identidad contextual y ciclo de vida del vínculo | — (abierta; `ADR-001` y `ADR-002` previstos)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
- **Ciclo de vida del vínculo propio** (F10, será `F10/ADR-001`): principio de
