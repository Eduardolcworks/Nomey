# F08/ADR-002 — Contrato de entornos, variantes y separación de configuración

- **Estado:** Aceptado
- **Fecha:** 2026-09-04
- **Identificador anterior:** ADR-031 (numeración única, anterior a la organización por fases del 2026-09-14)
...
- **No reemplaza a ningún ADR.** Complementa a
  [F08/ADR-001](../F08/ADR-001-native-code-model.md), que fija **cómo** se produce el
...
antes de publicar ([F08/ADR-001](../F08/ADR-001-native-code-model.md) §5).
