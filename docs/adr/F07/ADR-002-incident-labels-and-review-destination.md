# F07/ADR-002 — Etiquetas visibles de la incidencia, y a dónde lleva «Revisar»

- **Estado:** Aceptado
- **Fecha:** 2026-09-04
- **Identificador anterior:** ADR-029 (numeración única, anterior a la organización por fases del 2026-09-14)
- **Alcance:** cuatro decisiones de una misma corrección — la etiqueta
  ...
  pantalla, y las cuatro corrigen la misma sección de F07/ADR-001.
- **Supersede parcialmente:**
  [F07/ADR-001](../F07/ADR-001-offline-command-queue-and-optimistic-projection.md), §15, y
  **sólo en esos cuatro puntos**: la etiqueta visible del botón afirmativo de la
  ...
  lo demás de F07/ADR-001 sigue vigente y **no se reabre**: la taxonomía interna de §11, las dos formas
...
F07/ADR-001 §15 cerró qué es una incidencia, cuáles son las dos formas visibles y
...
justo el fallo que F07/ADR-001 existe para impedir.
...
Es la lectura estricta de [F02/ADR-001](../F02/ADR-001-money-representation.md) §7 y de
F07/ADR-001 §14: llevar el `12` de una definición a otra lo convierte en doce de
...
**A · Dejar `Reintentar`.** Es la palabra que F07/ADR-001 dibujó, y cambiarla obliga
...
Es lo que F07/ADR-001 §15 ya descartó, y sigue descartado: la distinción es interna
