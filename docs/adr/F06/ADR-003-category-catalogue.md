# F06/ADR-003 — Catálogo de categorías y su autorización

- **Estado:** Aceptado
- **Fecha:** 2026-08-28
- **Identificador anterior:** ADR-021 (numeración única, anterior a la organización por fases del 2026-09-14)
...
([F03/ADR-003](../F03/ADR-003-privilege-model.md)) · el actor sale siempre del JWT ·
`core.client_command` es la unidad de idempotencia del **comando contable**
([F03/ADR-008](../F03/ADR-008-operation-version-model.md) §5) · las escrituras que no son
...
F06/ADR-001 §8 fija para la moneda base.
...
(F03/ADR-010 §2). Lo comprueba la frontera, con un helper único y una **constante**
...
escrituras para la que **ya existe** `nomey_provisioner` —F06/ADR-001 lo creó para
