# F06/ADR-005 — Observación histórica de saldo

- **Estado:** Aceptado
- **Fecha:** 2026-08-29
- **Identificador anterior:** ADR-023 (numeración única, anterior a la organización por fases del 2026-09-14)
...
Eso choca de frente con **[F03/ADR-010](../F03/ADR-010-persisted-vs-derived.md) §1**, que
...
(F03/ADR-010 §1 y §9) · el protocolo de serialización de F03/ADR-010 §11, extendido al
saldo por [F06/ADR-004](../F06/ADR-004-balance-target-and-serialization.md).
...
- Una excepción explícita a F03/ADR-010 §1. Acotada, nombrada y con guarda, pero
  excepción.
...
- **Es lo que obliga a que las siete clases con saldo se serialicen**
  (F06/ADR-004 §5). Sin la observación, un delta ciego no necesitaría lock.
...
| **Materializar el saldo actual y leerlo de ahí** | La segunda fuente de verdad que F03/ADR-010 alternativa B ya descartó                                                                 |
| **No observar las anulaciones**                  | Dejaría el hueco de auditoría justo en el borrado                                                                                     |
| **Escribir la observación con un trigger**       | Lógica contable oculta, no puede calcular el «antes» con el puntero ya movido, y el proyecto ya rechazó los triggers en F06/ADR-001   |
