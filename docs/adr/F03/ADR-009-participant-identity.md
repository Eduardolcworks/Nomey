# F03/ADR-009 — Identidad de participantes sin cuenta y vínculo con usuarios

- **Estado:** Aceptado
- **Fecha:** 2026-08-24
- **Identificador anterior:** ADR-012 (numeración única, anterior a la organización por fases del 2026-09-14)
...
[F03/ADR-008](../F03/ADR-008-operation-version-model.md) dejó abierto a qué apuntan los
efectos, y [F03/ADR-004](../F03/ADR-004-membership-rls.md) fijó que la autorización por
...
que fija F03/ADR-004. El vínculo responde a otra pregunta: _«¿cuáles de estos
...
política de `core` aplicable a `PUBLIC`** (F03/ADR-008 §15). **Las políticas
...
misma objeción que F03/ADR-008 hizo a derivar la versión vigente en vez de apuntarla.
...
## Compatibilidad con F03/ADR-008
