# F03/ADR-003 — Modelo de privilegios y frontera de lectura `api` → `core`

- **Estado:** Aceptado
- **Fecha:** 2026-08-24
- **Identificador anterior:** ADR-006 (numeración única, anterior a la organización por fases del 2026-09-14)
...
- **[F01/ADR-001](../F01/ADR-001-accounting-model.md) §7** — los roles cliente no tienen
...
- **Qué columnas proyecta cada vista y dónde ocurre exactamente el cast a
  texto** que exige [F02/ADR-001](../F02/ADR-001-money-representation.md) §6. Es **D6**, y
...
- **El mecanismo de comprobación de membresía**, que fija
  [F03/ADR-004](../F03/ADR-004-membership-rls.md).
