# F03/ADR-007 — Idempotencia de las operaciones originadas por el cliente

- **Estado:** Aceptado
- **Fecha:** 2026-08-24
- **Identificador anterior:** ADR-010 (numeración única, anterior a la organización por fases del 2026-09-14)
...
([F03/ADR-006](../F03/ADR-006-authoritative-write-boundary.md) §3), **nunca del payload**,
