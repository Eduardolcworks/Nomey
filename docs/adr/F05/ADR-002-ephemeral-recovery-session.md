# F05/ADR-002 — La sesión de recuperación es efímera y no se promociona

- **Estado:** Aceptado
- **Fecha:** 2026-08-28
- **Identificador anterior:** ADR-018 (numeración única, anterior a la organización por fases del 2026-09-14)
...
**F05/ADR-001 no cambia ni se amplía.** Sigue siendo la política de persistencia de
