...
>
> - **Fases 0, 1, 2, 3, 4 y 5:** cerradas. **Los ADR de F00 a F06 (hasta F06/ADR-006) aceptados.**
...
>   F6.E—. La decisión es [F06/ADR-001](adr/F06/ADR-001-personal-provisioning.md); el
...
>   clase. Decisiones: [F06/ADR-002](adr/F06/ADR-002-version-content-and-time.md) y
...
>   [F06/ADR-006](adr/F06/ADR-006-annulment.md).
...
| Todos los ADR **aceptados**      | F00 … F06 (hasta F06/ADR-006) |
...
- **`architecture/code-structure.md`**, **`database/rls-policies.md`** y
  **`security/threat-model.md`** — de mantenimiento obligatorio en cuanto
  existan.
- **F02/ADR-001 ya está aceptado**, así que `architecture/data-model.md` y
