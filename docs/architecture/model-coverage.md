...
ocurre si no hay tipo exacto para una fecha. → No es de F3: **F02/ADR-001 §4 lo deja
expresamente fuera de alcance y F03/ADR-006 §8 lo declara decisión de producto
